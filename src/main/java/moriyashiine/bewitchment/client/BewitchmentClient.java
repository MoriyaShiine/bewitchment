...
public class BewitchmentClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		Identifier SILVER_LAYER_1 = new Identifier(Bewitchment.MODID, "textures/entity/armor/silver_layer_1.png");
		Identifier SILVER_LAYER_2 = new Identifier(Bewitchment.MODID, "textures/entity/armor/silver_layer_2.png");
		...
		Identifier HARBINGER = new Identifier(Bewitchment.MODID, "textures/entity/armor/harbinger.png");
		ArmorRenderingRegistry.registerTexture((livingEntity, itemStack, equipmentSlot, b, s, identifier) -> itemStack.getItem() == BWObjects.SILVER_LEGGINGS ? SILVER_LAYER_2 : SILVER_LAYER_1, BWObjects.SILVER_HELMET, BWObjects.SILVER_CHESTPLATE, BWObjects.SILVER_LEGGINGS, BWObjects.SILVER_BOOTS);
		...
		ArmorRenderingRegistry.registerTexture((livingEntity, itemStack, equipmentSlot, b, s, identifier) -> HARBINGER, BWObjects.HARBINGER);
