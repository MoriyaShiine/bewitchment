...
public class DruidBandModel extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		woodDetails.addChild("leaf02_r1", ModelPartBuilder.create().uv(9, 12).cuboid(-1.5F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(-0.4F, -0.4F, -0.4F)), ModelTransform.of(0.25F, -4.0F, -2.0F, 0.0F, -0.3054F, 0.0F));
		woodDetails.addChild("leaf03_r1", ModelPartBuilder.create().uv(1, 12).cuboid(-1.5F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(-0.4F, -0.4F, -0.4F)), ModelTransform.of(0.25F, -4.0F, 1.75F, 0.0F, 0.3054F, 0.0F));
