...
public class WitchArmorModel<T extends LivingEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexuredModelData() {
		...
		hood01.addChild("hoodFringeL01", ModelPartBuilder.create().uv(77, 24).cuboid(0.0F, -0.3F, -5.39F, 2.0F, 8.0F, 10.0F), ModelTransform.of(-4.1F, -8.2F, 0.1F, 0.0F, 0.0F, 0.2793F));
		...
		hood01.addChild("hoodFringeR02", ModelPartBuilder.create().uv(97, 33).cuboid(-5.0F, -0.9F, -5.37F, 5.0F, 2.0F, 10.0F), ModelTransform.of(-0.85F, 0.55F, 0.1F, 0.0F, 0.0F, 0.3142F));
		...
		hood01.addChild("hoodFringeR04", ModelPartBuilder.create().uv(57, 20).cuboid(-3.0F, -1.0F, -5.38F, 4.0F, 2.0F, 11.0F), ModelTransform.of(-0.8F, -8.9F, 0.1F, 0.0F, 0.0F, -0.3142F));
		...
		armorRightArm.addChild("lArmSleeve02_r1", ModelPartBuilder.create().uv(50, 100).cuboid(-2.3F, -2.2F, -0.5F, 4.0F, 4.0F, 2.0F), ModelTransform.of(-2.0F, 7.0F, 2.0F, 0.5236F, 0.0F, 0.0F));
		...
		armorRightBoot.addChild("rBootClaw03_r1", ModelPartBuilder.create().uv(87, 94).cuboid(0.0F, 0.0F, -4.0F, 1.0F, 2.0F, 5.0F, new Dilation(-0.1F, -0.1F, -0.1F)), ModelTransform.of(0.5F, 8.75F, -2.25F, 0.6545F, -0.1745F, 0.0F));
		armorRightBoot.addChild("rBootClaw02_r1", ModelPartBuilder.create().uv(87, 94).cuboid(0.0F, 0.0F, -4.0F, 1.0F, 2.0F, 5.0F, new Dilation(-0.1F, -0.1F, -0.1F)), ModelTransform.of(-1.5F, 8.75F, -2.25F, 0.6545F, 0.1745F, 0.0F));
		armorRightBoot.addChild("rBootClaw01_r1", ModelPartBuilder.create().uv(87, 94).cuboid(0.0F, 0.0F, -4.25F, 1.0F, 2.0F, 5.0F, new Dilation(-0.1F, -0.1F, -0.1F)), ModelTransform.of(-0.5F, 8.75F, -2.25F, 0.6545F, 0.0F, 0.0F));
