...
public class WitchArmorModel<T extends LivingEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData armorRightBoot = root.addChild("armorRightBoot", ModelPartBuilder.create().uv(86, 81).mirrored(true).cuboid(-2.5F, 6.0F, -2.5F, 5.0F, 7.0F, 5.0F, new Dilation(-0.1F, -0.1F, -0.1F)).uv(110, 89).cuboid(-2.5F, 11.0F, -4.25F, 5.0F, 2.0F, 2.0F, new Dilation(-0.1F, -0.1F, -0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		...
		ModelPartData armorLeftArm = root.addChild("armorLeftArm", ModelPartBuilder.create().uv(47, 82).mirrored(true).cuboid(-0.5F, -2.9F, -2.5F, 5.0F, 12.0F, 5.0F, new Dilation(-0.1F, -0.1F, -0.1F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
