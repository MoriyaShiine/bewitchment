...
public class ZephyrHarnessModel extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		armorBody.addChild("rFeather_r1", ModelPartBuilder.create().uv(0, 2).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 9.0F, 6.0F), ModelTransform.of(-4.5F, 24.0F, -0.75F, 0.0F, 0.0F, 0.0F));
		armorBody.addChild("lFeather_r1", ModelPartBuilder.create().uv(0, 2).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 9.0F, 6.0F), ModelTransform.of(4.5F, 24.0F, -1.0F, 0.0F, 0.0F, 0.0F));
