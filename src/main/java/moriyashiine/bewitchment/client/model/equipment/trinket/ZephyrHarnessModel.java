	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData armorBody = root.addChild("armorBody",
				ModelPartBuilder.create()
						.cuboid(-4.5F, 23.0F, -2.5F, 9.0F, 2.0F, 5.0F, new Dilation(-0.2F, -0.2F, -0.2F)),
				ModelTransform.of(0.0F, -20.0F, 2.5F, 0.0F, 0.0F, 0.0F));
		armorBody.addChild("rFeather_r1",
				ModelPartBuilder.create()
						.uv(0, 2).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 9.0F, 6.0F),
				ModelTransform.of(-4.5F, 24.0F, -0.75F, 0.0F, 0.3491F, 0.1745F));
		armorBody.addChild("lFeather_r1",
				ModelPartBuilder.create()
						.uv(0, 2).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 9.0F, 6.0F),
				ModelTransform.of(4.5F, 24.0F, -1.0F, 0.0F, -0.3491F, -0.1745F));
