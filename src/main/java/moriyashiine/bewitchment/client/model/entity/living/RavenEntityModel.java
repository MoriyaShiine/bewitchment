	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = root.addChild("body",
				ModelPartBuilder.create()
						.cuboid(-2.0F, -1.5F, -2.5F, 4.0F, 3.0F, 6.0F),
				ModelTransform.of(0.0F, 18.2F, -1.6F, -0.3142F, 0.0F, 0.0F));
		ModelPartData neck = body.addChild("neck",
				ModelPartBuilder.create()
						.uv(16, 0).cuboid(-1.5F, -1.3F, -3.0F, 3.0F, 2.0F, 3.0F),
				ModelTransform.of(0.0F, 0.0F, -0.9F, -0.5236F, 0.0F, 0.0F));
		neck.addChild("neckFeathers01",
				ModelPartBuilder.create()
						.uv(13, 27).cuboid(-1.49F, -0.5F, -0.2F, 3.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, 1.1F, -1.7F, -0.4014F, 0.0F, 0.0F));
		neck.addChild("neckFeathers02",
				ModelPartBuilder.create()
						.uv(0, 27).cuboid(-1.5F, -0.5F, -0.2F, 3.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, 0.7F, -2.3F, -0.8727F, 0.0F, 0.0F));
		ModelPartData head = neck.addChild("head",
				ModelPartBuilder.create()
						.uv(40, 0).cuboid(-1.49F, -1.5F, -2.7F, 3.0F, 3.0F, 3.0F),
				ModelTransform.of(0.0F, -0.4F, -2.5F, 0.8727F, 0.0F, 0.0F));
		head.addChild("beakBottom",
				ModelPartBuilder.create()
						.uv(54, 0).cuboid(-0.49F, -0.5F, -2.8F, 1.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, 0.8F, -1.9F, -0.0873F, 0.0F, 0.0F));
		head.addChild("beakTop",
				ModelPartBuilder.create()
						.uv(54, 0).cuboid(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, -0.1F, -2.3F, 0.1396F, 0.0F, 0.0F));
		ModelPartData tail01 = body.addChild("tail01",
				ModelPartBuilder.create()
						.uv(0, 10).cuboid(-1.5F, -0.5F, 0.0F, 3.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, -0.9F, 3.4F, 0.0524F, 0.0F, 0.0F));
		tail01.addChild("tail02",
				ModelPartBuilder.create()
						.uv(0, 15).cuboid(-1.49F, -0.5F, -0.4F, 3.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, 0.8F, 0.0F, 0.0F, 0.0F, 0.0F));
		tail01.addChild("middleTalePlume",
				ModelPartBuilder.create()
						.uv(49, 6).cuboid(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 6.0F),
				ModelTransform.of(0.0F, -0.2F, 1.7F, 0.0F, 0.0F, 0.0F));
		tail01.addChild("lTailPlume",
				ModelPartBuilder.create()
						.uv(51, 13).cuboid(-1.5F, -0.7F, -0.2F, 3.0F, 0.0F, 4.0F),
				ModelTransform.of(-0.5F, 0.7F, 1.2F, 0.0F, -0.5236F, 0.1745F));
		...
		ModelPartData lLeg01 = body.addChild("lLeg01",
				ModelPartBuilder.create()
						.uv(34, 0).cuboid(-1.0F, 0.2F, -1.0F, 1.0F, 2.0F, 2.0F),
				ModelTransform.of(-1.2F, 0.1F, 2.3F, 0.3142F, 0.0F, 0.0F));
		ModelPartData lLeg02 = lLeg01.addChild("lLeg02",
				ModelPartBuilder.create()
						.uv(29, 0).cuboid(-0.49F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F),
				ModelTransform.of(-0.5F, 2.0F, 0.0F, -0.1396F, 0.0F, 0.0F));
		lLeg02.addChild("lFoot",
				ModelPartBuilder.create()
						.uv(29, 5).cuboid(-0.51F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F),
				ModelTransform.of(0.0F, 2.6F, 0.0F, 0.1396F, 0.0F, 0.0F));
		ModelPartData rLeg01 = body.addChild("rLeg01",
				ModelPartBuilder.create()
						.uv(34, 0).cuboid(0.0F, 0.2F, -1.0F, 1.0F, 2.0F, 2.0F),
				ModelTransform.of(1.2F, 0.1F, 2.3F, 0.3142F, 0.0F, 0.0F));
		ModelPartData rLeg02 = rLeg01.addChild("rLeg02",
				ModelPartBuilder.create()
						.uv(29, 0).cuboid(-0.51F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F),
				ModelTransform.of(0.5F, 2.0F, 0.0F, -0.1396F, 0.0F, 0.0F));
		rLeg02.addChild("rFoot",
				ModelPartBuilder.create()
						.uv(29, 5).cuboid(-0.49F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F),
				ModelTransform.of(0.0F, 2.6F, 0.1F, 0.1396F, 0.0F, 0.0F));
		body.addChild("tail03",
				ModelPartBuilder.create()
						.uv(0, 20).cuboid(-1.5F, 0.0F, -0.8F, 3.0F, 1.0F, 3.0F),
				ModelTransform.of(0.0F, 0.4F, 3.5F, 0.2094F, 0.0F, 0.0F));
		body.addChild("bodyFeathers",
				ModelPartBuilder.create()
						.uv(26, 26).cuboid(-1.5F, 0.0F, -2.5F, 3.0F, 1.0F, 5.0F),
				ModelTransform.of(0.0F, 1.1F, 1.1F, 0.1396F, 0.0F, 0.0F));
		ModelPartData lWing01 = body.addChild("lWing01",
				ModelPartBuilder.create()
						.uv(10, 10).cuboid(-4.0F, -0.5F, -1.0F, 4.0F, 1.0F, 6.0F),
				ModelTransform.of(-1.9F, -0.3F, -1.1F, -0.0873F, 1.2741F, 0.0F));
		ModelPartData lWing02 = lWing01.addChild("lWing02",
				ModelPartBuilder.create()
						.uv(12, 18).cuboid(-4.0F, -0.51F, -1.0F, 4.0F, 1.0F, 7.0F),
				ModelTransform.of(-3.5F, 0.0F, 0.0F, 0.0F, 0.4538F, 0.0F));
		ModelPartData lWing03 = lWing02.addChild("lWing03",
				ModelPartBuilder.create()
						.uv(31, 9).cuboid(-4.0F, -0.5F, -1.0F, 4.0F, 1.0F, 7.0F),
				ModelTransform.of(-3.5F, 0.0F, 0.0F, 0.0F, 0.4887F, 0.0F));
		lWing03.addChild("lWing04",
				ModelPartBuilder.create()
						.uv(29, 18).cuboid(-8.0F, -0.5F, -1.0F, 8.0F, 0.0F, 6.0F),
				ModelTransform.of(-1.8F, 0.4F, 0.0F, 0.0F, 0.0F, 0.0F));
		ModelPartData rWing01 = body.addChild("rWing01",
				ModelPartBuilder.create()
						.uv(10, 10).cuboid(0.0F, -0.5F, -1.0F, 4.0F, 1.0F, 6.0F),
				ModelTransform.of(1.9F, -0.3F, -1.1F, -0.0873F, -1.2741F, 0.0F));
		ModelPartData rWing02 = rWing01.addChild("rWing02",
				ModelPartBuilder.create()
						.uv(12, 18).cuboid(0.0F, -0.51F, -1.0F, 4.0F, 1.0F, 7.0F),
				ModelTransform.of(3.5F, 0.0F, 0.0F, 0.0F, -0.4538F, 0.0F));
		ModelPartData rWing03 = rWing02.addChild("rWing03",
				ModelPartBuilder.create()
						.uv(31, 9).cuboid(0.0F, -0.51F, -1.0F, 4.0F, 1.0F, 7.0F),
				ModelTransform.of(3.5F, 0.0F, 0.0F, 0.0F, -0.4887F, 0.0F));
		rWing03.addChild("rWing04",
				ModelPartBuilder.create()
						.uv(29, 18).cuboid(0.0F, -0.5F, -1.0F, 8.0F, 0.0F, 6.0F),
				ModelTransform.of(1.8F, 0.4F, 0.0F, 0.0F, 0.0F, 0.0F));
