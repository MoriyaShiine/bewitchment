...
public class BaphometEntityModel<T extends BaphometEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		realBody.addChild("boobLeft", ModelPartBuilder.create().uv(18, 52).cuboid(-1.5F, 0.5F, -1.8F, 3.0F, 3.0F, 3.0F), ModelTransform.of(1.6F, 1.9F, -0.8F, -0.6981F, -0.1745F, 0.0F));
		...
		ModelPartData rWing01 = realBody.addChild("rWing01", ModelPartBuilder.create().uv(57, 40).cuboid(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 6.0F), ModelTransform.of(-1.8F, 2.8F, 1.4F, 0.3491F, -0.6458F, 0.0F));
		...
		rWing03.addChild("rFeathers02", ModelPartBuilder.create().uv(90, 13).cuboid(-0.5F, -0.6F, -13.7F, 1.0F, 16.0F, 16.0F), ModelTransform.of(0.1F, 2.3F, 0.0F, -0.4363F, 0.0F, 0.0F));
		rWing02.addChild("rFeathers01", ModelPartBuilder.create().uv(65, 31).cuboid(-0.5F, -0.6F, -11.1F, 1.0F, 10.0F, 22.0F), ModelTransform.of(-0.2F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
		ModelPartData lWing01 = realBody.addChild("lWing01", ModelPartBuilder.create().uv(57, 40).cuboid(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 6.0F), ModelTransform.of(1.8F, 2.8F, 1.4F, 0.3491F, 0.6458F, 0.0F));
		...
		lWing03.addChild("lFeathers02", ModelPartBuilder.create().uv(90, 13).cuboid(-0.5F, -0.6F, -13.7F, 1.0F, 16.0F, 16.0F), ModelTransform.of(-0.1F, 2.3F, 0.0F, -0.4363F, 0.0F, 0.0F));
		lWing02.addChild("lFeathers01", ModelPartBuilder.create().uv(65, 31).cuboid(-0.5F, -0.6F, -11.1F, 1.0F, 10.0F, 22.0F), ModelTransform.of(0.2F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
		...
		ModelPartData rLeg02 = BipedRightLeg.addChild("rLeg02", ModelPartBuilder.create().uv(0, 32).cuboid(-1.5F, 0.0F, -2.0F, 3.0F, 8.0F, 4.0F), ModelTransform.of(-0.2F, 7.6F, -1.3F, 0.7679F, 0.1396F, 0.0436F));
		ModelPartData rLeg03 = rLeg02.addChild("rLeg03", ModelPartBuilder.create().uv(0, 44).cuboid(-1.0F, 0.0F, -1.5F, 2.0F, 10.0F, 3.0F), ModelTransform.of(0.0F, 6.0F, 0.2F, -0.4887F, 0.0F, -0.1047F));
		ModelPartData rHoofClaw01a = rLeg03.addChild("rHoofClaw01a", ModelPartBuilder.create().uv(9, 58).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), ModelTransform.of(-0.5F, 9.5F, -1.3F, 0.0F, 0.1396F, 0.0349F));
		rHoofClaw01a.addChild("rHoofClaw01b", ModelPartBuilder.create().uv(0, 57).cuboid(-0.51F, -1.1F, -1.2F, 1.0F, 1.0F, 3.0F), ModelTransform.of(0.0F, 0.0F, -1.0F, 0.3491F, 0.0F, 0.0F));
		ModelPartData rHoofClaw02a = rLeg03.addChild("rHoofClaw02a", ModelPartBuilder.create().uv(9, 58).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), ModelTransform.of(0.5F, 9.5F, -1.3F, 0.0F, -0.1396F, -0.0349F));
		rHoofClaw02a.addChild("rHoofClaw02b", ModelPartBuilder.create().uv(0, 57).cuboid(-0.51F, -1.1F, -1.2F, 1.0F, 1.0F, 3.0F), ModelTransform.of(0.0F, 0.0F, -1.0F, 0.3491F, 0.0F, 0.0F));
		root.addChild("BipedRightArm", ModelPartBuilder.create().uv(46, 19).cuboid(-2.0F, -2.0F, -2.0F, 3.0F, 16.0F, 4.0F), ModelTransform.of(-5.0F, -10.8F, 0.0F, 0.0F, 0.0F, 0.1F));
		...
		ModelPartData rHorn01 = realHead.addChild("rHorn01", ModelPartBuilder.create().uv(23, 0).cuboid(-1.0F, -2.7F, -1.0F, 2.0F, 4.0F, 2.0F), ModelTransform.of(-2.9F, -7.2F, -0.2F, -0.1745F, -0.1396F, -0.4014F));
		ModelPartData rHorn02 = rHorn01.addChild("rHorn02", ModelPartBuilder.create().cuboid(-0.4F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.3F, 0.3F, 0.3F)), ModelTransform.of(0.0F, -2.2F, 0.0F, -0.1745F, 0.0F, -0.2618F));
		ModelPartData rHorn03 = rHorn02.addChild("rHorn03", ModelPartBuilder.create().uv(0, 4).cuboid(-0.3F, -3.0F, -0.6F, 1.0F, 3.0F, 1.0F, new Dilation(0.15F, 0.15F, 0.15F)), ModelTransform.of(0.0F, -2.7F, 0.0F, -0.1047F, 0.0F, -0.1745F));
		ModelPartData rHorn04 = rHorn03.addChild("rHorn04", ModelPartBuilder.create().cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F), ModelTransform.of(0.0F, -2.8F, 0.0F, 0.0524F, 0.0F, -0.1396F));
		rHorn04.addChild("rHorn05", ModelPartBuilder.create().cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0524F, 0.0F, 0.1396F));
		...
		realHead.addChild("rEar", ModelPartBuilder.create().uv(48, 0).cuboid(-4.0F, -0.5F, -1.0F, 4.0F, 1.0F, 2.0F), ModelTransform.of(-2.6F, -6.0F, 0.8F, -0.3491F, 0.0F, -0.3142F));
		...
		torch02a.addChild("torch03a", ModelPartBuilder.create().uv(122, 6).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F), ModelTransform.of(-0.6F, -1.5F, -0.6F, 0.2443F, -0.1396F, -0.2793F));
		...
		torch02a.addChild("torch03d", ModelPartBuilder.create().uv(122, 10).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F), ModelTransform.of(-0.6F, -1.5F, 0.6F, -0.2443F, 0.2094F, -0.2793F));
		...
		realHead.addChild("rCheekFur", ModelPartBuilder.create().uv(31, 54).cuboid(-5.0F, -2.5F, 0.0F, 5.0F, 5.0F, 0.0F), ModelTransform.of(-2.4F, -2.4F, -0.3F, -0.6981F, 0.3491F, -0.576F));
