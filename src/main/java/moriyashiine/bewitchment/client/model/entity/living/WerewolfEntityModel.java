...
public class WerewolfEntityModel<T extends WerewolfEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(49, 15).cuboid(-5.5F, -3.3F, -2.0F, 11.0F, 11.0F, 8.0F), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.5672F, 0.0F, 0.0F));
		...
		ModelPartData stomach = body.addChild("stomach", ModelPartBuilder.create().uv(16, 16).cuboid(-5.0F, 0.0F, -3.0F, 10.0F, 12.0F, 6.0F), ModelTransform.of(0.0F, 6.9F, 2.6F, -0.3927F, 0.0F, 0.0F));
		...
		ModelPartData rLeg02 = BipedRightLeg.addChild("rLeg02", ModelPartBuilder.create().uv(0, 35).cuboid(-1.99F, 0.4F, -2.0F, 4.0F, 7.0F, 4.0F), ModelTransform.of(0.0F, 9.8F, 0.5F, 1.309F, 0.0524F, 0.0F));
		ModelPartData rLeg03 = rLeg02.addChild("rLeg03", ModelPartBuilder.create().uv(0, 22).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 10.0F, 3.0F), ModelTransform.of(0.0F, 5.9F, 0.8F, -0.7854F, 0.0F, -0.0873F));
		ModelPartData rFoot = rLeg03.addChild("rFoot", ModelPartBuilder.create().uv(0, 14).cuboid(-2.0F, 0.0F, -2.8F, 4.0F, 2.0F, 5.0F), ModelTransform.of(0.0F, 8.7F, -1.2F, 0.1309F, -0.0436F, 0.0087F));
		rFoot.addChild("rFootClaw01", ModelPartBuilder.create().uv(1, 48).cuboid(-0.5F, -0.5F, -1.7F, 1.0F, 2.0F, 3.0F), ModelTransform.of(1.3F, 0.5F, -2.6F, 0.2269F, -0.1047F, 0.0F));
		rFoot.addChild("rFootClaw02", ModelPartBuilder.create().uv(1, 48).cuboid(-0.5F, -0.5F, -1.7F, 1.0F, 2.0F, 3.0F), ModelTransform.of(0.0F, 0.5F, -2.6F, 0.2269F, 0.0F, 0.0F));
		rFoot.addChild("rFootClaw03", ModelPartBuilder.create().uv(1, 48).cuboid(-0.5F, -0.5F, -1.7F, 1.0F, 2.0F, 3.0F), ModelTransform.of(-1.3F, 0.5F, -2.6F, 0.2269F, 0.1047F, 0.0F));
		body.addChild("fur04", ModelPartBuilder.create().uv(90, 35).cuboid(-2.5F, 1.0F, 0.0F, 5.0F, 4.0F, 2.0F), ModelTransform.of(0.0F, -0.3F, 4.9F, 0.4363F, 0.0F, 0.0F));
		body.addChild("fur03", ModelPartBuilder.create().uv(90, 24).cuboid(-4.0F, 0.0F, -1.0F, 8.0F, 7.0F, 2.0F), ModelTransform.of(0.0F, -2.6F, 4.5F, 0.6807F, 0.0F, 0.0F));
		body.addChild("fur02", ModelPartBuilder.create().uv(90, 11).cuboid(-5.0F, -1.0F, -1.0F, 10.0F, 8.0F, 2.0F), ModelTransform.of(0.0F, -4.7F, 3.4F, 0.8727F, 0.0F, 0.0F));
		...
		ModelPartData rArm02 = rArm01.addChild("rArm02", ModelPartBuilder.create().uv(49, 46).cuboid(-1.5F, -1.0F, -1.5F, 3.0F, 13.0F, 3.0F), ModelTransform.of(0.0F, 11.5F, 0.0F, -0.5236F, 0.0F, -0.1484F));
		rArm02.addChild("rArmFur", ModelPartBuilder.create().uv(62, 50).cuboid(-0.5F, -0.5F, 1.5F, 1.0F, 8.0F, 4.0F), ModelTransform.of(-0.4F, -4.0F, 0.0F, -0.4363F, -0.0873F, -0.0873F));
		...
		rClawJoint.addChild("rClaw01", ModelPartBuilder.create().uv(27, 0).cuboid(-0.6F, 1.2F, -1.6F, 2.0F, 5.0F, 1.0F), ModelTransform.of(-1.0F, 0.2F, 0.0F, -0.1047F, 0.0F, -0.2269F));
		rClawJoint.addChild("rClaw02", ModelPartBuilder.create().uv(27, 0).cuboid(-0.6F, 1.2F, -0.5F, 2.0F, 5.0F, 1.0F), ModelTransform.of(-1.0F, 0.2F, -0.1F, 0.0F, 0.0F, -0.2269F));
		rClawJoint.addChild("rClaw03", ModelPartBuilder.create().uv(27, 0).cuboid(-0.6F, 1.2F, -0.5F, 2.0F, 5.0F, 1.0F), ModelTransform.of(-1.0F, 0.2F, 0.8F, 0.1047F, 0.0F, -0.2269F));
		...
		ModelPartData head2 = neck.addChild("head2", ModelPartBuilder.create().uv(44, 0).cuboid(-4.0F, -3.0F, -4.4F, 8.0F, 6.0F, 7.0F), ModelTransform.of(0.0F, -0.5F, -3.6F, 1.9199F, 0.0F, 0.0F));
		ModelPartData jawUpperLeft = head2.addChild("jawUpperLeft", ModelPartBuilder.create().uv(20, 36).cuboid(-1.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F), ModelTransform.of(1.2F, -5.1F, -1.5F, 0.0F, 0.0F, -0.1396F));
		...
		ModelPartData jawUpperRight = head2.addChild("jawUpperRight", ModelPartBuilder.create().uv(20, 36).cuboid(-1.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F), ModelTransform.of(-1.2F, -5.1F, -1.5F, 0.0F, 0.0F, 0.1396F));
		...
		ModelPartData lEar01 = head2.addChild("lEar01", ModelPartBuilder.create().uv(70, 0).cuboid(0.0F, -1.0F, -1.6F, 1.0F, 3.0F, 2.0F), ModelTransform.of(2.8F, -0.1F, 2.8F, 0.6981F, 0.1222F, -0.6981F));
		lEar01.addChild("lEar02", ModelPartBuilder.create().uv(78, 0).cuboid(-1.4F, 2.0F, -1.4F, 1.0F, 5.0F, 1.0F), ModelTransform.of(-0.3F, -3.0F, -0.5F, 0.2269F, 0.0F, -0.2618F));
		ModelPartData rEar01 = head2.addChild("rEar01", ModelPartBuilder.create().uv(70, 0).cuboid(-1.0F, -1.0F, -1.6F, 1.0F, 3.0F, 2.0F), ModelTransform.of(-2.8F, -0.1F, 2.8F, 0.6981F, -0.1222F, 0.6981F));
		...
		head2.addChild("lCheekFur", ModelPartBuilder.create().uv(26, 4).cuboid(0.0F, -0.8F, -3.3F, 0.0F, 6.0F, 5.0F), ModelTransform.of(3.5F, -0.5F, -0.6F, 0.1222F, -0.0873F, -0.5236F));
		head2.addChild("rCheekFur", ModelPartBuilder.create().uv(26, 4).cuboid(0.0F, -0.8F, -3.3F, 0.0F, 6.0F, 5.0F), ModelTransform.of(-3.5F, -0.5F, -0.6F, 0.1222F, 0.0873F, 0.5236F));
		head2.addChild("snout", ModelPartBuilder.create().uv(29, 35).cuboid(-1.5F, -3.2F, -2.0F, 3.0F, 5.0F, 2.0F), ModelTransform.of(0.0F, -4.2F, -0.1F, 0.182F, 0.0F, 0.0F));
