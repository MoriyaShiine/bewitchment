...
public class LeonardEntityModel<T extends LeonardEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		realBody.addChild("rPec", ModelPartBuilder.create().uv(14, 42).cuboid(-2.5F, -2.5F, -3.0F, 5.0F, 5.0F, 3.0F), ModelTransform.of(-2.2F, 3.1F, -0.1F, 0.0F, 0.0873F, -0.0873F));
		...
		realHead.addChild("lEar", ModelPartBuilder.create().uv(37, 29).cuboid(0.0F, -0.5F, -1.0F, 4.0F, 1.0F, 2.0F), ModelTransform.of(2.6F, -5.0F, 0.8F, -0.5236F, 0.0F, -0.5236F));
		realHead.addChild("rEar", ModelPartBuilder.create().uv(37, 29).cuboid(-4.0F, -0.5F, -1.0F, 4.0F, 1.0F, 2.0F), ModelTransform.of(-2.6F, -5.0F, 0.8F, -0.5236F, 0.0F, 0.5236F));
		ModelPartData lHorn01 = realHead.addChild("lHorn01", ModelPartBuilder.create().uv(25, 0).cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(2.0F, -6.0F, -0.2F, -0.6109F, 0.0F, 0.5236F));
		ModelPartData lHorn02 = lHorn01.addChild("lHorn02", ModelPartBuilder.create().uv(25, 1).cuboid(-1.0F, -2.9F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(0.0F, -2.7F, 0.0F, -0.3142F, 0.0F, 0.2094F));
		ModelPartData lHorn03 = lHorn02.addChild("lHorn03", ModelPartBuilder.create().uv(0, 1).cuboid(-0.5F, -2.8F, -0.6F, 1.0F, 3.0F, 1.0F, new Dilation(0.2F, 0.2F, 0.2F)), ModelTransform.of(0.0F, -2.6F, 0.0F, -0.3142F, 0.0F, 0.0F));
		lHorn03.addChild("lHorn04", ModelPartBuilder.create().cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.4014F, 0.0F, 0.0F));
		ModelPartData rHorn01 = realHead.addChild("rHorn01", ModelPartBuilder.create().uv(25, 0).cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(-2.0F, -6.0F, -0.2F, -0.6109F, 0.0F, -0.5236F));
		...
		ModelPartData rHorn03 = rHorn02.addChild("rHorn03", ModelPartBuilder.create().uv(0, 1).cuboid(-0.5F, -2.8F, -0.6F, 1.0F, 3.0F, 1.0F, new Dilation(0.2F, 0.2F, 0.2F)), ModelTransform.of(0.0F, -2.6F, 0.0F, -0.3142F, 0.0F, 0.0F));
		rHorn03.addChild("rHorn04", ModelPartBuilder.create().cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.4014F, 0.0F, 0.0F));
		...
		ModelPartData rLeg02 = BipedRightLeg.addChild("rLeg02", ModelPartBuilder.create().uv(0, 31).cuboid(-2.0F, -0.1F, -2.0F, 4.0F, 10.0F, 4.0F), ModelTransform.of(0.0F, 9.7F, 0.0F, 0.0698F, 0.0F, -0.0349F));
		rLeg02.addChild("rFlipper01", ModelPartBuilder.create().uv(30, 42).cuboid(-2.0F, 0.0F, -3.0F, 3.0F, 1.0F, 5.0F), ModelTransform.of(-0.3F, 8.8F, -1.7F, 0.0F, 0.1745F, -0.0349F));
		rLeg02.addChild("rFlipper02", ModelPartBuilder.create().uv(28, 48).cuboid(-0.9F, 0.0F, -3.0F, 2.0F, 1.0F, 5.0F), ModelTransform.of(0.9F, 8.8F, -1.7F, 0.0F, -0.1396F, 0.0349F));
		...
		BipedRightArm.addChild("rClaws", ModelPartBuilder.create().uv(0, 45).cuboid(-1.1F, 0.0F, -2.1F, 2.0F, 3.0F, 4.0F), ModelTransform.of(-1.4F, 12.9F, -0.1F, 0.0F, 0.0F, -0.2793F));
