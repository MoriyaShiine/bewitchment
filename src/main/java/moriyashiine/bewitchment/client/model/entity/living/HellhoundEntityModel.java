...
public class HellhoundEntityModel<T extends HellhoundEntity> extends EntityModel<T> {
	...
	public HellhoundEntityModel() {
		...
		setRotationAngle(rHorn01, -1.0016F, -0.4554F, 0.0F);
		...
		setRotationAngle(rHorn02, -0.5236F, -0.1745F, 0.0F);
		...
		setRotationAngle(rHorn03, -0.6981F, -0.2094F, 0.0F);
		...
		setRotationAngle(rHorn04, -0.6981F, 0.0F, 0.0F);
		...
		setRotationAngle(rHorn05, -0.6981F, -0.3491F, 0.0F);
		...
		setRotationAngle(rHorn06, -0.6283F, 0.0F, 0.0F);
		...
		setRotationAngle(lHorn01, -1.0016F, 0.4554F, 0.0F);
		...
		setRotationAngle(lHorn02, -0.5236F, 0.1745F, 0.0F);
		...
		setRotationAngle(lHorn03, -0.6981F, 0.2094F, 0.0F);
		...
		setRotationAngle(lHorn04, -0.6981F, 0.0F, 0.0F);
		...
		setRotationAngle(lHorn05, -0.6981F, 0.3491F, 0.0F);
		...
		setRotationAngle(lHorn06, -0.6283F, 0.0F, 0.0F);
		...
		setRotationAngle(tail00, -1.0472F, 0.0F, 0.0F);
		...
		setRotationAngle(tail01, 0.2731F, 0.0F, 0.0F);
		...
		setRotationAngle(tail04, 0.0F, 0.0F, -0.7854F);
