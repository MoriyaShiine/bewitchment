...
public class HellhoundEntityModel<T extends HellhoundEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData rHorn01 = head.addChild("rHorn01", ModelPartBuilder.create().uv(46, 0).cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(-1.3F, -2.1F, -1.4F, -1.0016F, -0.4554F, 0.0F));
		ModelPartData rHorn02 = rHorn01.addChild("rHorn02", ModelPartBuilder.create().uv(55, 0).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F), ModelTransform.of(0.0F, -2.5F, -0.1F, -0.5236F, -0.1745F, 0.0F));
		ModelPartData rHorn03 = rHorn02.addChild("rHorn03", ModelPartBuilder.create().uv(52, 7).cuboid(-0.8F, -2.0F, -0.8F, 1.0F, 2.0F, 1.0F, new Dilation(0.2F, 0.2F, 0.2F)), ModelTransform.of(0.0F, -1.5F, -0.1F, -0.6981F, -0.2094F, 0.0F));
		ModelPartData rHorn04 = rHorn03.addChild("rHorn04", ModelPartBuilder.create().uv(57, 6).cuboid(-0.7F, -3.0F, -0.7F, 1.0F, 3.0F, 1.0F, new Dilation(0.15F, 0.15F, 0.15F)), ModelTransform.of(0.0F, -1.5F, -0.1F, -0.6981F, 0.0F, 0.0F));
		ModelPartData rHorn05 = rHorn04.addChild("rHorn05", ModelPartBuilder.create().uv(52, 12).cuboid(-0.5F, -3.0F, -0.7F, 1.0F, 3.0F, 1.0F, new Dilation(0.1F, 0.1F, 0.1F)), ModelTransform.of(0.0F, -2.5F, -0.1F, -0.6981F, -0.3491F, 0.0F));
		rHorn05.addChild("rHorn06", ModelPartBuilder.create().uv(58, 13).cuboid(-0.51F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F), ModelTransform.of(0.0F, -2.7F, 0.0F, -0.6283F, 0.0F, 0.0F));
