...
public class HerneEntityModel<T extends HerneEntity> extends BipedEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		bipedRightArm.addChild("rMantle", ModelPartBuilder.create().uv(69, 45).cuboid(-2.5F, -2.0F, -3.0F, 5.0F, 8.0F, 6.0F), ModelTransform.of(0.1F, -0.3F, -0.5F, 0.0F, 0.0F, 0.1309F));
		...
		chest.addChild("rPec", ModelPartBuilder.create().uv(19, 50).cuboid(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F), ModelTransform.of(-2.6F, -4.8F, -1.2F, 0.0F, 0.1047F, -0.0873F));
		...
		ModelPartData rLeg02 = bipedRightLeg.addChild("rLeg02", ModelPartBuilder.create().uv(0, 34).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(-0.3F, -0.3F, -0.3F)), ModelTransform.of(0.0F, 9.5F, -0.7F, 0.733F, 0.0F, -0.0873F));
		ModelPartData rLeg03 = rLeg02.addChild("rLeg03", ModelPartBuilder.create().uv(0, 47).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new Dilation(-0.15F, -0.15F, -0.15F)), ModelTransform.of(0.0F, 7.1F, 0.1F, -0.4538F, 0.0F, 0.0F));
		ModelPartData rHoofClaw01a = rLeg03.addChild("rHoofClaw01a", ModelPartBuilder.create().uv(9, 60).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), ModelTransform.of(-0.7F, 8.4F, -1.4F, 0.0524F, 0.1047F, 0.0F));
		rHoofClaw01a.addChild("rHoofClaw01b", ModelPartBuilder.create().uv(0, 59).cuboid(-0.51F, -1.1F, -1.2F, 1.0F, 1.0F, 3.0F), ModelTransform.of(0.0F, 0.0F, -0.8F, 0.3491F, 0.0F, 0.0F));
		ModelPartData rHoofClaw02a = rLeg03.addChild("rHoofClaw02a", ModelPartBuilder.create().uv(9, 60).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F), ModelTransform.of(0.6F, 8.4F, -1.4F, 0.0524F, -0.0524F, 0.0F));
		rHoofClaw02a.addChild("rHoofClaw02b", ModelPartBuilder.create().uv(0, 59).cuboid(-0.51F, -1.1F, -1.2F, 1.0F, 1.0F, 3.0F), ModelTransform.of(0.0F, 0.0F, -0.8F, 0.3491F, 0.0F, 0.0F));
		...
		realHead.addChild("lEar", ModelPartBuilder.create().uv(20, 0).cuboid(0.0F, -1.0F, -0.5F, 3.0F, 2.0F, 1.0F), ModelTransform.of(2.3F, -3.4F, 0.9F, 0.1745F, -0.3491F, -0.4538F));
		realHead.addChild("rEar", ModelPartBuilder.create().uv(20, 0).cuboid(-3.0F, -1.0F, -0.5F, 3.0F, 2.0F, 1.0F), ModelTransform.of(-2.3F, -3.4F, 0.9F, 0.1745F, 0.3491F, 0.4538F));
		ModelPartData lAntler01 = realHead.addChild("lAntler01", ModelPartBuilder.create().uv(107, 0).cuboid(-1.0F, -2.3F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(1.5F, -4.6F, -0.6F, -0.3491F, 0.0F, 0.2793F));
		ModelPartData lAntler02a = lAntler01.addChild("lAntler02a", ModelPartBuilder.create().uv(107, 0).cuboid(-0.2F, -0.5F, 0.0F, 1.0F, 1.0F, 6.0F), ModelTransform.of(-0.2F, -1.7F, -0.3F, 0.7854F, 0.5236F, 0.1396F));
		...
		ModelPartData rAntler01 = realHead.addChild("rAntler01", ModelPartBuilder.create().uv(107, 0).cuboid(-1.0F, -2.2F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.of(-1.5F, -4.7F, -0.6F, -0.3491F, 0.0F, -0.2793F));
		ModelPartData rAntler02a = rAntler01.addChild("rAntler02a", ModelPartBuilder.create().uv(107, 0).cuboid(-0.2F, -0.5F, 0.0F, 1.0F, 1.0F, 6.0F), ModelTransform.of(0.2F, -1.7F, -0.3F, 0.7854F, -0.5236F, -0.1396F));
