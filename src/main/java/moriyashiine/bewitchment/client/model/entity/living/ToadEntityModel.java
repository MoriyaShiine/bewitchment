...
public class ToadEntityModel<T extends ToadEntity> extends AnimalModel<T> {
	...
	public ToadEntityModel() {
		...
		setRotation(lArm01, -0.1745F, 0.0F, -0.3491F);
		...
		setRotation(lArm02, -0.3491F, 0.0F, 0.2618F);
		...
		setRotation(lHand, 0.4538F, 0.0873F, 0.0873F);
		...
		setRotation(rArm01, -0.1745F, 0.0F, 0.3491F);
		...
		setRotation(rArm02, -0.3491F, 0.0F, -0.2618F);
		...
		setRotation(rHand, 0.4538F, -0.0873F, -0.0873F);
		...
		setRotation(lLeg01, -1.0036F, -0.3491F, -0.1396F);
		...
		setRotation(lLeg02, 0.6981F, 0.0F, 0.0F);
		...
		setRotation(lFoot, 0.3578F, 0.0F, 0.1309F);
		...
		setRotation(rLeg01, -1.0036F, 0.3491F, 0.1396F);
		...
		setRotation(rLeg02, 0.6981F, 0.0F, 0.0F);
		...
		setRotation(rFoot, 0.3578F, 0.0F, -0.1309F);
