...
public class OwlEntityModel<T extends OwlEntity> extends AnimalModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData lWing01 = body.addChild("lWing01", ModelPartBuilder.create().uv(34, 0).cuboid(-5.0F, -0.7F, -0.5F, 5.0F, 8.0F, 1.0F), ModelTransform.of(-3.9F, 1.0F, -0.2F, 0.0F, 0.9599F, -0.8727F));
		ModelPartData lWing02 = lWing01.addChild("lWing02", ModelPartBuilder.create().uv(47, 0).cuboid(-6.0F, -0.7F, -0.5F, 6.0F, 9.0F, 1.0F), ModelTransform.of(-4.5F, 0.0F, 0.1F, 0.0F, 0.0F, -0.6981F));
		ModelPartData lWing03 = lWing02.addChild("lWing03", ModelPartBuilder.create().uv(32, 10).cuboid(-6.0F, -0.6F, -0.5F, 6.0F, 10.0F, 1.0F), ModelTransform.of(-4.2F, -0.1F, 0.1F, 0.0F, 0.0F, -0.6109F));
		...
		head.addChild("lEar", ModelPartBuilder.create().uv(25, 1).cuboid(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F), ModelTransform.of(-2.3F, -4.1F, 0.0F, -0.2618F, 0.0F, -0.4014F));
