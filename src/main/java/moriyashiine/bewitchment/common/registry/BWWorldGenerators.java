...
public class BWWorldGenerators {
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> JUNIPER_TREE = create("juniper_tree", Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(BWObjects.JUNIPER_LOG.getDefaultState()), new SimpleBlockStateProvider(BWObjects.JUNIPER_LEAVES.getDefaultState()), new AcaciaFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0)), new ForkingTrunkPlacer(6, 2, 2), EMPTY_SIZE).ignoreVines().build()));
