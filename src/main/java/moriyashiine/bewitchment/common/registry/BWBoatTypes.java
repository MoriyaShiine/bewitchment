...
public class BWBoatTypes {
	...
	public static void init() {
		Item juniper_boat = TerraformBoatItemHelper.registerBoatItem(new Identifier(Bewitchment.MODID, "juniper_boat"), () -> juniper, false, Bewitchment.BEWITCHMENT_GROUP);
		...
		Item cypress_boat = TerraformBoatItemHelper.registerBoatItem(new Identifier(Bewitchment.MODID, "cypress_boat"), () -> cypress, false, Bewitchment.BEWITCHMENT_GROUP);
		...
		Item elder_boat = TerraformBoatItemHelper.registerBoatItem(new Identifier(Bewitchment.MODID, "elder_boat"), () -> elder, false, Bewitchment.BEWITCHMENT_GROUP);
		...
		Item dragons_blood_boat = TerraformBoatItemHelper.registerBoatItem(new Identifier(Bewitchment.MODID, "dragons_blood_boat"), () -> dragons_blood, false, Bewitchment.BEWITCHMENT_GROUP);
