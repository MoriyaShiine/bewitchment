...
public class BWContracts {
	...
	public static final Contract SLOTH = create("sloth", new Contract(true));
	...
	public static final Contract PESTILENCE = create("pestilence", new Contract(true));
	public static final Contract WAR = create("war", new Contract(true));
	public static final Contract DEATH = create("death", new Contract(false));
