...
public class SmellySigil extends Sigil {
	...
	public int tick(World world, BlockPos pos) {
		...
		if (!world.isClient && world.getTime() % 20 == 0) {
			...
			for (HostileEntity entity : world.getEntitiesByClass(HostileEntity.class, new Box(pos).expand(16, 6, 16), entity -> entity.getNavigation().getTargetPos() == null || world.getBlockState(entity.getNavigation().getTargetPos()).getBlock() != BWObjects.SIGIL)) {
