...
public class DistillingRecipe extends BWRecipe {
	private final Identifier id;
	public final List<Ingredient> input;
	public final ItemStack output;
	
	public DistillingRecipe(Identifier id, List<Ingredient> input, ItemStack output) {
		this.id = id;
		this.input = input;
		this.output = output;
	}
	...
	public RecipeSerializer<?> getSerializer() {
		return BWRecipeTypes.distilling_serializer;
	}
	
	@Override
	public RecipeType<?> getType() {
		return BWRecipeTypes.distilling_type;
	}
	...
	public static class Serializer implements RecipeSerializer<DistillingRecipe> {
		...
		public DistillingRecipe read(Identifier id, JsonObject json) {
			...
			return new DistillingRecipe(id, ingredients, output);
		}
