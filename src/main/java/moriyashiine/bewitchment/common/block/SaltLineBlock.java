...
import moriyashiine.bewitchment.api.accessor.EntityShapeContextAdditionAccesor;
...
public class SaltLineBlock extends Block {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		if (context instanceof EntityShapeContext) {
			EntityShapeContextAdditionAccesor accessor = EntityShapeContextAdditionAccesor.of((EntityShapeContext) context).orElse(null);
			if (accessor != null) {
