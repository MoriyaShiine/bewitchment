...
public class CandelabraBlock extends Block implements Waterloggable {
	...
	public CandelabraBlock(Settings settings) {
		super(settings);
		setDefaultState(getDefaultState().with(Properties.LIT, false).with(Properties.WATERLOGGED, false));
	}
	...
	public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
		...
		if (!state.get(Properties.LIT) && !state.get(Properties.WATERLOGGED)) {
