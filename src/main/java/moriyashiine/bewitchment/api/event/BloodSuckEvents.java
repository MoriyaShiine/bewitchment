...
public final class BloodSuckEvents {
    public static final Event<OnBloodSuck> ON_BLOOD_SUCK = createArrayBacked(OnBloodSuck.class,
            listeners -> (player, target, bloodToGive) -> {
    ...
    public static final Event<SetBloodAmount> BLOOD_AMOUNT = createArrayBacked(SetBloodAmount.class,
            listeners -> (player, target, bloodToGive) -> {
