...
public final class BloodSetEvents {
    public static final Event<OnFillBlood> ON_BLOOD_FILL = createArrayBacked(OnFillBlood.class,
            listeners -> (entity, amount, simulate) -> {
    ...
    public static final Event<OnDrainBlood> ON_BLOOD_DRAIN = createArrayBacked(OnDrainBlood.class,
            listeners -> (entity, amount, simulate) -> {
